...
consts.datasetDir = '/data/dataset/2012_eccv_support_inference/';
...
consts.spamsPath = '~/code/spams/latest/release/mkl64/';
...
%   http://www.gurobi.com
consts.gurobiPath = '~/code1/gurobi/gurobi550/linux64/matlab/';
...
consts.boundaryInfoVisualize = true;
consts.boundaryVisualizeDir = [consts.datasetDir 'boundary_visualize/'];
consts.boundaryVisualizeFileName = [consts.boundaryVisualizeDir 'visualize_type%d_stgs%d_%06d.png'];
